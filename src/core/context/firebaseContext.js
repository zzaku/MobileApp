...
/**/                  const deleteUserPreferences = doc(db, "Users", idUser, "", document._key.path.segments.at(-1))
...
/**/               elem.docs.map( async (document) => {
/**/                  const deleteCurrentResume = doc(db, "Users", idUser, "", document._key.path.segments.at(-1))
